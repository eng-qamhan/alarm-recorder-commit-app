    ...
    _rateMyApp.init().then(
      (_) {
        if (_rateMyApp.shouldOpenDialog) {
          launchAppRating(
              context,
              AppLocalizations.of(context).translate("rate_title"),
              AppLocalizations.of(context).translate("rate_message"));
        }
      },
    );
  }
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text(
                          AppLocalizations.of(context).translate("arabic_main"),
                          style: TextStyle(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      padding:
                          EdgeInsets.only(top: sizeConfig.screenWidth * .1),
                      child: Row(
              ...
              child: ListBody(
                children: <Widget>[
                  Text(
                    nextIsSelected
                        ? AppLocalizations.of(context)
                            .translate("location_on_background3")
                        : AppLocalizations.of(context)
                            .translate("location_on_background2"),
