...
class MyChoice extends StatefulWidget {
  ...
  MyChoice(
      ...
      this.camera,
      this.location,
      this.descriptionControllertext,
      this.imgString,
      this.note});
  @override
...
class _MyChoiceState extends State<MyChoice> {
  ...
  Widget build(BuildContext context) {
    ...
    return dialog(widget.result, context, widget.nameRecord, widget.edit,
        widget.camera, widget.location);
  }
  ...
  Widget _player(
      isPlay, minute, seconds, AudioPlayerObject object, data, int i) {
    return Container(
          ...
          children: <Widget>[
            Stack(
              children: <Widget>[
                ...
                Container(
                  child: streamPLayer(widget.result),
                )
              ],
            ),
            SizedBox(
                  ...
                  onPressed: () {
                    if (widget.note == "note") {
                      saveNote(
                          widget.id,
                          widget.edit,
                          widget.descriptionControllertext,
                          widget.imgString,
                          context,
                          camera,
                          location);
